...
5.  Location View
    ...
    -   Use the <img src="images\google-earth\5-zoom.png" alt="zoom button" style="width:120px;"> at the bottom right corner to zoom in and out
    ...
    -   To get a Street View, go to the bottom right corner and click on <img src="images\google-earth\5-person.png" alt="person icon" style="width:90px;">
    
        <img src="images\google-earth\5-light-blue.png" alt="highlighted areas" style="float:right;width:240px;">
    ...
    -   To change the view, repeat the steps for the 2D example (Note: no need to use SHIFT to rotate and tilt; the mouse does everything)
        ...
        <img src="images\google-earth\5-search-bar.png" alt="search bar" style="float:right;width:240px;">
